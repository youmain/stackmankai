...
import type { TurnData, PlayerAction } from "@/types/post"
...
export function PostCreationStep4({ data, onUpdate }: Props) {
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-6">
        <h3 className="text-xl font-bold text-foreground mb-2">ターン</h3>
        <p className="text-muted-foreground">ターンカードとアクションを入力してください</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="description">ターンの詳細</Label>
          <Textarea
            id="description"
            placeholder="ターンでの思考過程、戦略の変化など"
