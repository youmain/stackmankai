...
import type { RiverData, PlayerAction } from "@/types/post"
import { CardSelector } from "@/components/card-selector"

interface Props {
  data: RiverData
  onUpdate: (data: Partial<RiverData>) => void
}

export function PostCreationStep5({ data, onUpdate }: Props) {
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-6">
        <h3 className="text-xl font-bold text-foreground mb-2">リバー</h3>
        <p className="text-muted-foreground">リバーカードとアクションを入力してください</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="description">リバーの詳細</Label>
          <Textarea
            id="description"
            placeholder="リバーでの思考過程、最終的な判断理由など"
