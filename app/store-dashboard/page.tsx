          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {storeInfo.isStoreOwner && (
              <>
                ...
                >
                  <div className="text-left">
                    <div className="font-semibold mb-1">店舗設定</div>
                    <div className="text-sm opacity-90">Stack Man Hand・レーキ・リセット</div>
                  </div>
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  onClick={() => router.push("/store-stack-man-hand-admin")}
                  className="flex items-center justify-between p-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-xl hover:from-orange-600 hover:to-orange-700 transition-all shadow-md hover:shadow-lg"
                >
                  <div className="text-left">
                    <div className="font-semibold mb-1">Stack Man Hand管理</div>
                    <div className="text-sm opacity-90">レーキ回収・リセット実行</div>
                  </div>
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
