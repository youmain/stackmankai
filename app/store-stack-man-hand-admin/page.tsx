  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        const handsRef = collection(db, "stores", storeIdFromStorage, "stackManHands")
        ...
        const rakeRef = collection(db, "stores", storeIdFromStorage, "rakeCollections")
        ...
        const resetRef = collection(db, "stores", storeIdFromStorage, "stackResets")
